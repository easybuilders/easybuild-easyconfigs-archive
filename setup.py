...
"""
This script can be used to install easybuild-easyconfigs-archive, e.g. using:
   easy_install --user .
 or
...
setup(
    ...
    description="""Collection of old easyconfig files from easybuild-easyconfigs. \
Easyconfig files in this archive are no longer supported.""",
    license="GPLv2",
    ...
    requires=[
        ...
        "easybuild_easyconfigs(>=%s)" % MAJMIN_VER,
    ],
